...
export default function OrdersPage() {
    ...
    const { orders, loading, updatingId, loadingStatus, selectedOrder } = state;
                ...
                {orders.length === 0 ? (
                    ...
                    <div className="p-4 md:p-0">
                                        ...
                                        <tr key={order.id} className="hover:bg-[var(--secondary)]/50 transition-colors group">
                                            ...
                                            <td className="px-8 py-6 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    <button
                                                        onClick={() => actions.setSelectedOrder(order)}
                        ...
                        <div className="md:hidden space-y-4 p-4">
                            {orders.map((order) => (
                                <div key={order.id} className="bg-[var(--surface)] border border-[var(--border)] rounded-3xl p-6 space-y-4 shadow-[var(--shadow)] active:scale-[0.98] transition-all" onClick={() => actions.setSelectedOrder(order)}>
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-[var(--surface)] w-full max-w-2xl rounded-[2.5rem] shadow-[var(--shadow-strong)] overflow-hidden animate-in zoom-in-95 duration-200">
                        ...
                        <div className="p-8 border-b border-[var(--border)] flex items-center justify-between bg-[var(--bg)]/30">
                            ...
                            <button
                                onClick={() => actions.setSelectedOrder(null)}
                                    ...
                                    {selectedOrder.status === 'PENDING' ? (
                                        <div className="grid grid-cols-2 gap-3">
                                            <button
                                                ...
                                                onClick={() => actions.handleUpdateStatus(selectedOrder.id, 'COMPLETED')}
                                            ...
                                            <button
                                                disabled={updatingId === selectedOrder.id}
                                                onClick={() => actions.handleUpdateStatus(selectedOrder.id, 'CANCELLED')}
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <button
                                                disabled={updatingId === selectedOrder.id}
                                                onClick={() => actions.handleUpdateStatus(selectedOrder.id, 'PENDING')}
