...
import {
    ...
    Youtube, Truck, DollarSign, Sun, Moon
} from 'lucide-react';
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
                                    {[
                                        ...
                                        <button key={t.id} type="button" onClick={() => actions.setTheme(t.id)} className={cn("p-4 rounded-3xl border-2 transition-all text-left flex flex-col gap-4", state.theme === t.id ? 'border-[var(--primary)] bg-[var(--primary)]/5 ring-4 ring-[var(--primary)]/5 shadow-lg' : 'border-[var(--border)] bg-[var(--surface)] hover:border-[var(--text)]/10')}>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                                    {[
                                        ...
                                        <button key={m.id} type="button" onClick={() => actions.setMode(m.id)} className={cn("p-6 rounded-2xl border-2 flex flex-col items-center justify-center gap-2 transition-all", state.mode === m.id ? m.cls : 'border-[var(--border)] text-[var(--text)]/40 hover:border-[var(--text)]/10 shadow-sm')}>
