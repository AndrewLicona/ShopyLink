...
import type { Store, Product, Category, Order } from '@/types/types';
...
export const api = {
    ...
    getStoreBySlug: (slug: string, options: RequestInit = {}): Promise<Store> =>
        fetchWithAuth(`/stores/${slug}`, options),
