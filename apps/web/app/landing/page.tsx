...
export default function SimplifiedLanding() {
    return (
        <div className="min-h-screen bg-white text-gray-900 selection:bg-blue-600 selection:text-white flex flex-col">
            {/* Hero Section */}
            <section className="relative pt-20 pb-12 flex-1 flex flex-col items-center justify-center overflow-hidden px-6">
                ...
                <div className="relative text-center max-w-lg mx-auto">
                    <div className="flex items-center justify-center gap-2 mb-8 group">
                        ...
                        <span className="text-3xl font-black tracking-tight">Shopy<span className="text-blue-600">Link</span></span>
                    </div>
